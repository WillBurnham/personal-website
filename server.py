...
def handle_data():    
    ...
    no_search_results = [("Please enter a valid word.", 1)]
    ...
    for char in word:
        if (char.isalpha() == False):
            return render_template("projects.html", results = no_search_results, austin_image = aus_img, dallas_image = dal_img, houston_image = hou_img)
    ...
    if results:
        return render_template("projects.html", results = results, austin_image = aus_img, dallas_image = dal_img, houston_image = hou_img)
